...
""" A* Algorithm :  To find the efficient and effective path form the
    Entry pixel of the maze image to the Exit pixel maze image"""
...
def solve(maze):
    width = maze.width
    total = maze.width * maze.height  # Total no.of pixels
